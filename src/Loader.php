...
class Loader
{
    ...
    /**
     * @var string Whenever something is detected in a file being scanned, a
     *      human-readable description of that detection is appended here. This
     *      variable contains the "Detected ... !" message you see at the
     *      "Upload Denied!" page generated by the upload handler whenever an
     *      upload is blocked.
     */
    public $WhyFlagged = '';

    /**
     * @var string Contains references to any files flagged during scanning in
     *      the form of "HASH:FILESIZE:FILENAME".
     */
    public $HashReference = '';

    /**
     * @var string If the file being scanned happens to be a PE file, in
     *      addition to the information appended to $WhyFlagged and
     *      $HashReference, references to the individual PE sections of the
     *      files in question will be appended here.
     */
    public $PEData = '';
    ...
    /**
     * This function returns the contents of files.
     *
     * @param string $File The file to read.
